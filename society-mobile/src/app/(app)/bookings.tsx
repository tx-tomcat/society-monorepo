...
import { ArrowRight, Calendar, Clock, MapPin, Star, VerifiedBadge } from '@/components/ui/icons';
...
const DAY_KEYS = ['sun_short', 'mon_short', 'tue_short', 'wed_short', 'thu_short', 'fri_short', 'sat_short'] as const;

// Month keys for i18n
const MONTH_KEYS = ['jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec'] as const;

// Status configuration mapping to Badge variants
const STATUS_CONFIG: Record<BookingStatus, { labelKey: string; variant: 'pending' | 'confirmed' | 'completed' | 'cancelled' }> = {
    pending: {
                    ...
                    <View className="mb-4 flex-row flex-wrap gap-3">
                        ...
                        <View className="w-full flex-row items-center gap-2.5">
                            ...
                            <View className="flex-1">
                                ...
                                <Text className="font-urbanist-semibold text-sm text-midnight" numberOfLines={1}>
                                    {booking.location}
                                </Text>
                            </View>
                        </View>
    ...
    return (
        ...
        >
            ...
            <View className="relative mb-6 size-[140px] items-center justify-center">
                <View className="size-[100px] items-center justify-center rounded-[30px] bg-lavender-400/15">
...
export default function MyBookings() {
    ...
    const formatDateI18n = React.useCallback((date: Date) => {
    ...
    const bookings = React.useMemo(() => {
        ...
        return bookingsData.bookings.map((b) => {
            ...
            const dateInfo = startDate ? formatDateI18n(startDate) : { dayOfWeek: '', date: '' };
            return {
                id: b.id,
                companion: {
                ...
                totalPrice: b.totalPrice || (b.durationHours || 1) * (b.companion?.hourlyRate || 0),
        ...
        <View className="flex-1 bg-warmwhite">
            ...
            {isLoading ? (
                ...
                <FlashList
                    ...
                    contentContainerStyle={{ paddingTop: 20, paddingHorizontal: 16, paddingBottom: 32 }}
                    refreshControl={
                        <RefreshControl
