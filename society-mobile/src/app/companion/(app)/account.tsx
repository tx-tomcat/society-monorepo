...
const MENU_ITEMS: MenuItem[] = [
    ...
    },
    {
        ...
        icon: Fire,
        iconColor: colors.rose[400],
        labelKey: 'companion.boost.header',
        route: '/companion/settings/boost',
    },
    {
        id: 'bank-account',
        icon: Bank,
                    ...
                    {MENU_ITEMS.map((item, index) => {
                        ...
                        return (
                            <Pressable
                                ...
                                className={`flex-row items-center py-3 ${index < MENU_ITEMS.length - 1 ? 'mb-3' : ''
                                    }`}
                            >
                                ...
                                {badge ? (
                                    <View
                                        className={`rounded-xl px-2.5 py-1 ${badge.variant === 'verified'
                                            ? 'bg-teal-400/10'
                                            : 'bg-yellow-400/10'
                                            }`}
                                    >
                                        <Text
                                            className={`text-xs font-semibold ${badge.variant === 'verified'
                                                ? 'text-teal-400'
                                                : 'text-yellow-500'
                                                }`}
                                        >
